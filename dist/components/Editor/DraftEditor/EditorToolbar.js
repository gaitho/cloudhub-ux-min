...
var editorToolbar = {
  inline: {
    bold: {
      icon: ICONS.inline_bold,
      className: 'toggle'
    },
    italic: {
      icon: ICONS.inline_italic,
      className: 'toggle'
    },
    underline: {
      icon: ICONS.inline_underline,
      className: 'toggle'
    },
    strikethrough: {
      icon: ICONS.inline_strikethrough,
      className: 'toggle'
    },
    monospace: {
      icon: ICONS.monospace,
      className: 'toggle'
    },
    superscript: {
  ...
  list: {
    ...
    indent: {
      icon: ICONS.list_indent,
      className: 'toggle'
    },
    outdent: {
      icon: ICONS.list_outdent,
      className: 'toggle'
    }
  },
  textAlign: {
  ...
  colorPicker: {
    ...
    className: 'toggle',
    popupClassName: (0, _clsx.default)('popup', 'popup__colorpicker')
  },
  link: {
    popupClassName: (0, _clsx.default)('popup', 'popup__link'),
    link: {
      icon: ICONS.link,
      className: 'toggle'
    },
  ...
  emoji: {
    icon: ICONS.emoji,
    className: 'toggle',
    popupClassName: (0, _clsx.default)('popup', 'popup__emoji')
  },
  embedded: {
    icon: ICONS.embedded,
    className: 'toggle',
    popupClassName: (0, _clsx.default)('popup', 'popup__embedded')
  },
  image: {
    icon: ICONS.image,
    className: 'toggle',
    popupClassName: (0, _clsx.default)('popup', 'popup__image'),
  ...
  history: {
    undo: {
      icon: ICONS.history_undo,
      className: 'toggle'
    },
    redo: {
      icon: ICONS.history_redo,
      className: 'toggle'
    }
  }
};
